...
/***/ "./src/app/_entry/finished_material.html":
/*!***********************************************!*\
  !*** ./src/app/_entry/finished_material.html ***!
  \***********************************************/
/*! no static exports found */
...
var FinishedMaterial = /** @class */ (function () {
    ...
    FinishedMaterial.prototype.f = function (selectedProductType) {
        ...
        if (this.activeProductType !== selectedProductType) {
            console.log("inside if");
            var arrayRawMaterial = this.globalcfg[selectedProductType];
    ...
    FinishedMaterial.prototype.ngOnInit = function () {
        ...
        this.apiService.getFinishedCfgAll().subscribe(function (resp) {
            ...
            _this.globalcfg = resp['cfg'];
            console.log(_this.globalcfg);
            _this.selectedProduct = _this.finishmaterialcfg[0];
            console.log(_this.selectedProduct);
            _this.productUnit = _this.selectedProduct.unit;
            _this.f(_this.selectedProduct.product_type);
        });
    };
    ...
    FinishedMaterial = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            ...
            template: __webpack_require__(/*! ./finished_material.html */ "./src/app/_entry/finished_material.html"),
...
/***/ "./src/app/_entry/raw_material.html":
/*!******************************************!*\
  !*** ./src/app/_entry/raw_material.html ***!
  \******************************************/
/*! no static exports found */
...
var RawMaterial = /** @class */ (function () {
    function RawMaterial(apiService) {
        this.apiService = apiService;
        this.uri = 'finishedproduct';
        this.apiresult = null;
        this.dataTosave = [];
    ...
    RawMaterial.prototype.ngOnInit = function () {
        ...
        this.apiService.getRawAll().subscribe(function (data) {
            ...
            _this.rawItemCfg = data['sizemap'];
            console.log(_this.rawItemCfg);
            _this.selectedMaterial = Object.keys(_this.materialmap)[0];
            console.log("defaultselection", _this.selectedMaterial);
            _this.sizemap = _this.rawItemCfg[_this.selectedMaterial];
            console.log(_this.sizemap);
        });
    };
    ...
    RawMaterial.prototype.edit = function (indexOfelement) {
        console.log("edit", indexOfelement);
    };
    RawMaterial.prototype.delete = function (indexOfelement) {
    ...
    RawMaterial = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Component"])({
            selector: 'rawitem',
            template: __webpack_require__(/*! ./raw_material.html */ "./src/app/_entry/raw_material.html"),
            styles: [__webpack_require__(/*! ./common.css */ "./src/app/_entry/common.css")]
        }),
        __metadata("design:paramtypes", [_services_api_service__WEBPACK_IMPORTED_MODULE_1__["ApiService"]])
    ], RawMaterial);
...
/*!**********************************!*\
  !*** ./src/app/_models/index.ts ***!
  \**********************************/
/*! exports provided: User, RawMaterialCfg, FinishedMaterialCfg, RawMaterialImp, FinishedProductImpl */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "RawMaterialCfg", function() { return _user__WEBPACK_IMPORTED_MODULE_0__["RawMaterialCfg"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "FinishedMaterialCfg", function() { return _user__WEBPACK_IMPORTED_MODULE_0__["FinishedMaterialCfg"]; });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "RawMaterialCfg", function() { return RawMaterialCfg; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "FinishedMaterialCfg", function() { return FinishedMaterialCfg; });
...
var RawMaterialCfg = /** @class */ (function () {
    function RawMaterialCfg() {
    }
    return RawMaterialCfg;
}());

var FinishedMaterialCfg = /** @class */ (function () {
    function FinishedMaterialCfg() {
    }
    return FinishedMaterialCfg;
}());

var RawMaterialImp = /** @class */ (function () {
    function RawMaterialImp(date, material, weight, industry) {
        this.date = date;
...
var ApiService = /** @class */ (function () {
    ...
    ApiService.prototype._handle_error = function (error) {
        ...
        return rxjs__WEBPACK_IMPORTED_MODULE_3__["Observable"].throw(message);
    };
    ApiService.prototype.getRawAll = function () {
    ...
    ApiService.prototype.getFinishedCfgAll = function () {
        var baseruri = _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].origin + _environments_environment__WEBPACK_IMPORTED_MODULE_1__["environment"].api;
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services__WEBPACK_IMPORTED_MODULE_0__["AuthenticationService"]])
    ], HeaderComponent);
...
module.exports = __webpack_require__(/*! /home/santosc/external_app/web-app-solanki/production-tracker/src/main.ts */"./src/main.ts");
